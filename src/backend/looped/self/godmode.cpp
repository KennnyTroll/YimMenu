...
namespace big
{
	class godmode_internal : looped_command
	{
		...
		{
			//PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(self::ped, FALSE);
			//ENTITY::SET_ENTITY_PROOFS(self::ped, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);

			PED::SET_PED_CONFIG_FLAG(self::ped, 2, TRUE);//CPED_CONFIG_FLAG_NoCriticalHits 
			PED::SET_PED_CONFIG_FLAG(self::ped, 24, TRUE); //CPED_CONFIG_FLAG_IgnoreSeenMelee 
			//CPED_CONFIG_FLAG_IsAimingGun = 78,
			//CPED_CONFIG_FLAG_PedIsArresting = 450,
			//CPED_CONFIG_FLAG_DisableVehicleCombat = 422,
			//CPED_CONFIG_FLAG_EquipJetpack = 349
			...
			//CPED_CONFIG_FLAG_BlockWeaponSwitching = 48,
			//CPED_CONFIG_FLAG_DisablePlayerLockon = 43,
			//CPED_CONFIG_FLAG_HasHelmet = 34, CPED_CONFIG_FLAG_UseHelmet = 35,
			//CPED_CONFIG_FLAG_DieWhenRagdoll = 33,
			//CPED_CONFIG_FLAG_DrownsInWater = 3,
		...
		virtual void on_disable() override
		{
			...
			//PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(self::ped, TRUE);
			PED::SET_PED_CONFIG_FLAG(self::ped, 2, FALSE);  //CPED_CONFIG_FLAG_NoCriticalHits
			PED::SET_PED_CONFIG_FLAG(self::ped, 24, FALSE); //CPED_CONFIG_FLAG_IgnoreSeenMelee 
		}
	};
